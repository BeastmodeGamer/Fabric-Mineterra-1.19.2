...
public class GoblinPeonEntity extends GoblinEntity {

    public GoblinPeonEntity(EntityType<? extends GoblinPeonEntity> entityType, World world) {
    ...
    protected void initGoals() {
        ...
        this.goalSelector.add(4, new GoblinPeonEntity.AttackGoal(this));
    ...
    protected void initEquipment(Random random, LocalDifficulty localDifficulty) {
        List<Item> weapons = List.of(ModItems.COPPER_SWORD, ModItems.COPPER_AXE, ModItems.COPPER_SHOVEL, ModItems.COPPER_PICKAXE, Items.AIR);
        Item item = weapons.get(random.nextInt(weapons.size()));
        this.equipStack(EquipmentSlot.MAINHAND, new ItemStack(item));
    }

    class AttackGoal extends MeleeAttackGoal {
        public AttackGoal(GoblinPeonEntity goblinPeon) {
            super(goblinPeon, 1.0D, false);
        }
